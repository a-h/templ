...
func (p *Server) DidChange(ctx context.Context, params *lsp.DidChangeTextDocumentParams) (err error) {
	...
	// Some gopls functionality will not work if a file is generated.
	gosource := strings.Replace(w.String(), "// Code generated by templ - DO NOT EDIT.", "// Code generated by templ - DO     EDIT.", 1)
	p.GoSource[string(params.TextDocument.URI)] = gosource
	// Change the path.
	params.TextDocument.URI = goURI
...
func (p *Server) DidOpen(ctx context.Context, params *lsp.DidOpenTextDocumentParams) (err error) {
	...
	p.SourceMapCache.Set(string(params.TextDocument.URI), sm)
	// Set the Go contents.
	params.TextDocument.Text = gosource
