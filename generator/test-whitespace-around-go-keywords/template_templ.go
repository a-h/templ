...
func WhitespaceIsConsistentInFalseIf() templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		if false {
			...
			templ_7745c5c3_Var9 := `Will Not Render`
...
func WhitespaceIsConsistentInSwitchNoDefault() templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		case true:
			...
			templ_7745c5c3_Var18 := `Will Not Render`
...
func WhitespaceIsConsistentInFor(i int) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		for j := 0; j < i; j++ {
			...
			templ_7745c5c3_Var22, templ_7745c5c3_Err = templ.JoinStringErrs(fmt.Sprint(j))
			if templ_7745c5c3_Err != nil {
