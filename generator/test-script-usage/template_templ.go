...
func ScriptOnLoad() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ_7745c5c3_Var1[11]) // "<script async crossorigin=\"true\" onload=\""
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		...
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ_7745c5c3_Var1[12]) // "\" src=\"url.to.some.script\"></script>"
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		return templ_7745c5c3_Err
...
var templ_7745c5c3_Var1 = []string{
	...
	"\"",
	">",
	"<script async crossorigin=\"true\" onload=\"",
	"\" src=\"url.to.some.script\"></script>",
}
