...
This will start the proxy server on port `7331` and open it in your default browser. If you'd like to disable it opening in your browser add the flag `--open-browser=false`.
